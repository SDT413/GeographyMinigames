  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'background': "url('/GeographyMinigames/assets/images/background.jpg')",
        'game-background': "url('/GeographyMinigames/assets/images/game.jpg')",
        'end-background': "url('/GeographyMinigames/assets/images/end.jpg')",
      },
    },
  },
  plugins: [],
