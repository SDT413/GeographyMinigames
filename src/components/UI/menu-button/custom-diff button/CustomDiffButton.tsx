                    ...
                    window.innerWidth >= 800 ? 100 :
                        window.innerWidth >= 768 ? 90 :
                            window.innerWidth >= 640 ? 80 :
                                window.innerWidth >= 480 ? 70 :
                                    window.innerWidth >= 375 ? 60 :
                                        window.innerWidth >= 360 ? 50 :
                                            window.innerWidth >= 320 ? 40 : 40);
                    ...
                    window.innerWidth >= 800 ? 40 :
                        window.innerWidth >= 768 ? 40 :
                            window.innerWidth >= 640 ? 35 :
                                window.innerWidth >= 480 ? 30 :
                                    window.innerWidth >= 375 ? 25 :
                                        window.innerWidth >= 360 ? 20 :
                                            window.innerWidth >= 320 ? 15 : 15);
